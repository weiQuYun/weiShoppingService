package com.wqy.config.security;

import com.wqy.config.MyProperties;
import com.wqy.config.security.filter.AdminAuthenticationProcessingFilter;
import com.wqy.config.security.filter.MyAuthenticationFilter;
import com.wqy.config.security.login.AdminAuthenticationEntryPoint;
import com.wqy.config.security.url.UrlAccessDecisionManager;
import com.wqy.config.security.url.UrlAccessDeniedHandler;
import com.wqy.config.security.url.UrlFilterInvocationSecurityMetadataSource;
